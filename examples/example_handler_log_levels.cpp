...
int main()
{
  ...
  QUILL_LOG_WARNING(logger, "This is a log warning example {}", 9);
  QUILL_LOG_ERROR(logger, "This is a log error example {}", 10);
  QUILL_LOG_CRITICAL(logger, "This is a log critical example {}", 11);
}

...
public:
    ...
    SBE_NODISCARD static const char *origOrderIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t origOrderIdId() SBE_NOEXCEPT
    {
        return 2;
    }
    ...
    SBE_NODISCARD bool origOrderIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }
    ...
    static SBE_CONSTEXPR std::uint64_t origOrderIdMinValue() SBE_NOEXCEPT
    {
        return UINT64_C(0x0);
    }
    ...
    static SBE_CONSTEXPR std::size_t origOrderIdEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }
    ...
    CancelOrder &origOrderId(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *cancelQuantityMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t cancelQuantityId() SBE_NOEXCEPT
    {
        return 3;
    }
    ...
    SBE_NODISCARD bool cancelQuantityInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }
    ...
    static SBE_CONSTEXPR std::uint32_t cancelQuantityMinValue() SBE_NOEXCEPT
    {
        return UINT32_C(0x0);
    }
    ...
    static SBE_CONSTEXPR std::size_t cancelQuantityEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }
    ...
    CancelOrder &cancelQuantity(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrder &putReason(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();

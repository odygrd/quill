...
public:
   ...
   */
  FileHandler(detail::std_fs::path const& filename, std::string const& mode, FilenameAppend append_to_filename);
...
protected:
   ...
   */
  explicit FileHandler(detail::std_fs::path const& filename);

protected:
  detail::std_fs::path _current_filename; /**< Includes the base filename and some additional info e.g. an appended date or an index */
};
} // namespace quill

...
#include "quill/core/PatternFormatter.h"
#include "quill/core/filters/FilterBase.h"
...
public:
   ...
   */
  QUILL_ATTRIBUTE_HOT virtual void write(FormatBuffer const &formatted_log_message,
  ...
  QUILL_NODISCARD bool apply_filters(char const* thread_id, std::chrono::nanoseconds log_message_timestamp,
                                     ...
                                     FormatBuffer const &formatted_record)
  {

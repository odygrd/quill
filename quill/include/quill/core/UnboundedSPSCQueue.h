...
public:
   ...
   * Constructor
   */
  explicit UnboundedSPSCQueue(uint32_t initial_bounded_queue_capacity, bool huge_pages = false)
   ...
   */
  QUILL_NODISCARD_ALWAYS_INLINE_HOT std::pair<std::byte*, std::optional<std::pair<BoundedSPSCQueue::integer_type, BoundedSPSCQueue::integer_type>>> prepare_read()
  {
    std::optional<std::pair<BoundedSPSCQueue::integer_type, BoundedSPSCQueue::integer_type>> allocation;

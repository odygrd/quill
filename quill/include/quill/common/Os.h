...
#include "quill/common/Common.h"     // for fs::path
...
QUILL_NODISCARD inline void* alloc_aligned(size_t size, size_t alignment, bool huge_pages = false)
{
#if defined(_WIN32)
 ...
 */
void inline free_aligned(void* ptr) noexcept
{
#if defined(_WIN32)
  _aligned_free(ptr);
#else
 ...
 */
QUILL_ATTRIBUTE_COLD inline time_t timegm(tm* tm)
{
#if defined(_WIN32)
 ...
 */
QUILL_NODISCARD QUILL_ATTRIBUTE_COLD inline bool is_colour_terminal() noexcept
{
#if defined(_WIN32)
  return true;
#else
 ...
 */
QUILL_NODISCARD QUILL_ATTRIBUTE_COLD inline bool is_in_terminal(FILE* file) noexcept
{
#if defined(_WIN32)

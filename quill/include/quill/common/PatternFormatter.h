...
#include "quill/backend/TimestampFormatter.h" // for TimestampFormatter
#include "quill/common/Attributes.h"          // for QUILL_NODISCARD
#include "quill/common/Common.h"              // for Timezone, Timezon...
#include "quill/common/Fmt.h"                 // for memory_buffer
...
#include "quill/common/Utilities.h"  // for strlength

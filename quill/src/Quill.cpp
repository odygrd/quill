...
/***/
Handler* file_handler(detail::std_fs::path const& filename, std::string const& mode, /* = std::string{} */
...
/***/
Handler* time_rotating_file_handler(detail::std_fs::path const& base_filename,
...
/***/
Handler* rotating_file_handler(detail::std_fs::path const& base_filename,

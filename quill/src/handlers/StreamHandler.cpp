...
{
/***/
StreamHandler::StreamHandler(detail::std_fs::path stream, FILE* file /* = nullptr */)
...
/***/
detail::std_fs::path const& StreamHandler::filename() const noexcept { return _filename; }

...
TEST_CASE("transit_event_bounded_buffer")
{
  ...
  for (size_t i = 0; i < 12; ++i)
  {
...

    {
      ...
      te1->structured_kvs = std::make_unique<std::vector<std::pair<std::string, std::string>>>();
      te1->structured_kvs->clear();
      te1->structured_kvs->emplace_back(std::string{"test1"} + std::to_string(i), std::string{});
      bte.push_back();
    }
...

    {
      ...
      te2->structured_kvs = std::make_unique<std::vector<std::pair<std::string, std::string>>>();
      te2->structured_kvs->clear();
      te2->structured_kvs->emplace_back(std::string{"test2"} + std::to_string(i), std::string{});
      bte.push_back();
    }
...

    {
      ...
      te3->structured_kvs = std::make_unique<std::vector<std::pair<std::string, std::string>>>();
      te3->structured_kvs->clear();
      te3->structured_kvs->emplace_back(std::string{"test3"} + std::to_string(i), std::string{});
      bte.push_back();
    }
...

    {
      ...
      te4->structured_kvs = std::make_unique<std::vector<std::pair<std::string, std::string>>>();
      te4->structured_kvs->clear();
      te4->structured_kvs->emplace_back(std::string{"test4"} + std::to_string(i), std::string{});
      bte.push_back();
    }
...
TEST_CASE("transit_event_bounded_buffer_integer_overflow")
{
  ...
  for (size_t i = 0; i < iterations; ++i)
  {
...

    {
      ...
      te->structured_kvs = std::make_unique<std::vector<std::pair<std::string, std::string>>>();
      te->structured_kvs->clear();
      te->structured_kvs->emplace_back(std::string{"test"} + std::to_string(i), std::string{});
      bte.push_back();
    }

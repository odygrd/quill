...
TEST_CASE("default_pattern_formatter")
{
  ...
  auto const& formatted_buffer = default_pattern_formatter.format(
    ...
    macro_metadata, &structured_kvs, std::string_view{log_msg.data(), log_msg.size()});
...
TEST_CASE("custom_pattern_timestamp_precision_none")
{
  ...
  std::string const expected_string =
    "01-23-2020 21:42:41 [31341] PatternFormatterTest.cpp:217 LOG_DEBUG test_logger This the "
...
TEST_CASE("custom_pattern_timestamp_strftime_reallocation_on_format_string_2")
{
  ...
  for (size_t i = 0; i < 5; ++i)
  {
    ...
    std::string const expected_string =
      "2020-01-23T21:42:41.0992202020-01-23T21:42:41 [31341] PatternFormatterTest.cpp:257 "
...
TEST_CASE("custom_pattern_timestamp_strftime_reallocation_when_adding_fractional_seconds")
{
  ...
  for (size_t i = 0; i < 5; ++i)
  {
    ...
    std::string const expected_string =
      "2020-01-23T21:42:41.21:42:41.0992202020-01-23T21:42:41 [31341] PatternFormatterTest.cpp:300 "
...
TEST_CASE("custom_pattern")
{
  ...
  std::string const expected_string =
    "01-23-2020 21:42:41.000023000 [31341] PatternFormatterTest.cpp:361 LOG_DEBUG test_logger "

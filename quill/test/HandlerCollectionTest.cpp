...
TEST_CASE("stdout_stderr_handlers")
{
  ...
  StreamHandler* filehandler_1 =
    hc.create_handler<FileHandler>("stdout", "a", FilenameAppend::None, FileEventNotifier{});
  ...
  StreamHandler* filehandler_2 =
    hc.create_handler<FileHandler>("stderr", "a", FilenameAppend::None, FileEventNotifier{});
...
TEST_CASE("create_get")
{
  ...
  StreamHandler* filehandler = hc.create_handler<FileHandler>(
    "create_get_file_handler", "w", FilenameAppend::None, FileEventNotifier{});

  // Request the same file handler
  StreamHandler* filehandler_2 = hc.create_handler<FileHandler>(
    "create_get_file_handler", "a", FilenameAppend::None, FileEventNotifier{});
...
TEST_CASE("subscribe_get_active_different_handlers")
{
  ...
  // Create a file handler
  StreamHandler* filehandler = hc.create_handler<FileHandler>(
    "create_get_file_handler_1", "w", FilenameAppend::None, FileEventNotifier{});

  // Request the same file handler
  StreamHandler* filehandler_2 = hc.create_handler<FileHandler>(
    "create_get_file_handler_2", "a", FilenameAppend::None, FileEventNotifier{});

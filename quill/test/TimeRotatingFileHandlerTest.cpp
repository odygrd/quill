...
TEST_CASE("construct_invalid_when")
{
  ...
  REQUIRE_THROWS(TimeRotatingFileHandler{filename, "a", quill::FilenameAppend::None, when, 1,
                                         std::numeric_limits<size_t>::max(), 1, Timezone::LocalTime,
                                         "12:00", FileEventNotifier{}, false});
}
...
{
  {
    ...
    REQUIRE_THROWS(TimeRotatingFileHandler{filename, "a", quill::FilenameAppend::None, "daily", 1,
                                           std::numeric_limits<size_t>::max(), 1,
                                           Timezone::LocalTime, at_time, FileEventNotifier{}, false});
  }

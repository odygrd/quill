...
protected:
   ...
   * @note Shutdown may request another Final flush after draining diagnostics generated by the
   *       first flush. Sinks must remain writable between these requests.
   */

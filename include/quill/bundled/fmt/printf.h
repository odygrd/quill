...
template <typename T, typename Context> class arg_converter {
 ...
 public:
  ...
  void operator()(U value) {
    ...
    if FMTQUILL_CONSTEXPR20 (sizeof(target_type) <= sizeof(int)) {
...
inline auto parse_printf_presentation_type(char c, type t, bool& upper)
  ...
  case 'X': upper = true; FMTQUILL_FALLTHROUGH;
  case 'x': return in(t, integral_set) ? pt::hex : pt::none;
  case 'E': upper = true; FMTQUILL_FALLTHROUGH;
  case 'e': return in(t, float_set) ? pt::exp : pt::none;
  case 'F': upper = true; FMTQUILL_FALLTHROUGH;
  case 'f': return in(t, float_set) ? pt::fixed : pt::none;
  case 'G': upper = true; FMTQUILL_FALLTHROUGH;
  case 'g': return in(t, float_set) ? pt::general : pt::none;
  case 'A': upper = true; FMTQUILL_FALLTHROUGH;
...
inline auto make_printf_args(T&... args)
    -> decltype(fmtquill::make_format_args<basic_printf_context<Char>>(args...)) {
...
template <typename... T>
FMTQUILL_DEPRECATED auto sprintf(basic_string_view<wchar_t> fmt, const T&... args)
    -> std::wstring {
...
template <typename... T>
FMTQUILL_DEPRECATED auto fprintf(std::FILE* f, basic_string_view<wchar_t> fmt,
                            const T&... args) -> int {

...
template <typename Char, typename... T> struct basic_fstring {
 ...
 public:
  ...
  FMTQUILL_CONSTEVAL FMTQUILL_ALWAYS_INLINE basic_fstring(const S& s) : str_(s) {
  ...
  FMTQUILL_ALWAYS_INLINE basic_fstring(const S&) : str_(S()) {
    FMTQUILL_CONSTEXPR auto sv = basic_string_view<Char>(S());
  ...
  FMTQUILL_DEPRECATED operator basic_string_view<Char>() const { return str_; }
...
template <typename T>
FMTQUILL_DEPRECATED auto join(std::initializer_list<T> list, wstring_view sep)
...
auto format(wformat_string<T...> fmt, T&&... args) -> std::wstring {
  return vformat(fmt.get(), fmtquill::make_wformat_args(args...));
}

template <typename OutputIt, typename... T>
auto format_to(OutputIt out, wformat_string<T...> fmt, T&&... args)
    -> OutputIt {
  return vformat_to(out, fmt.get(), fmtquill::make_wformat_args(args...));
}
...
template <typename OutputIt, typename... T,
          FMTQUILL_ENABLE_IF(detail::is_output_iterator<OutputIt, wchar_t>::value)>
FMTQUILL_INLINE auto format_to_n(OutputIt out, size_t n, wformat_string<T...> fmt,
                            T&&... args) -> format_to_n_result<OutputIt> {
  return vformat_to_n(out, n, fmt.get(), fmtquill::make_wformat_args(args...));
}
...
inline auto format_to_n(OutputIt out, size_t n, const S& fmt, T&&... args)
    -> format_to_n_result<OutputIt> {
  return vformat_to_n(out, n, fmtquill::basic_string_view<Char>(fmt),
                      fmtquill::make_format_args<buffered_context<Char>>(args...));
}
...
void print(std::FILE* f, wformat_string<T...> fmt, T&&... args) {
  return vprint(f, fmt.get(), fmtquill::make_wformat_args(args...));
}

template <typename... T> void print(wformat_string<T...> fmt, T&&... args) {
  return vprint(fmt.get(), fmtquill::make_wformat_args(args...));
}
...
inline auto format(text_style ts, wformat_string<T...> fmt, T&&... args)
    -> std::wstring {
  return fmtquill::vformat(ts, fmt.get(), fmtquill::make_wformat_args(args...));
}

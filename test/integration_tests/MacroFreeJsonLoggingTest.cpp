...
/***/
TEST_CASE("macro_free_json_file_logging")
{
  static constexpr size_t number_of_messages = 500u;
  static constexpr size_t number_of_threads = 6;
  static constexpr char const* json_filename = "macro_free_json_file_logging.json";
  static constexpr char const* filename = "macro_free_json_file_logging_file.log";

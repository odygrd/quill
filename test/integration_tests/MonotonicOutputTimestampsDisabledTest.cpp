...
TEST_CASE("monotonic_output_timestamps_disabled_by_default")
{
  static constexpr char const* filename = "monotonic_output_timestamps_disabled.log";
  static std::string const logger_name = "monotonic_output_timestamps_disabled_logger";
  ...
  REQUIRE_EQ(file_contents[1], "1970-01-01 00:00:01.000000000 INFO second");

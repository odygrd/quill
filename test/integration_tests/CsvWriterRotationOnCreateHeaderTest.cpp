...
/***/
TEST_CASE("csv_writer_rotating_file_sink_rotation_on_creation_does_not_duplicate_header")
{
  static constexpr char const* filename = "temperatures_rotation_on_creation.csv";
  static constexpr char const* filename_1 = "temperatures_rotation_on_creation.1.csv";

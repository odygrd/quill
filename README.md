...
### Verdict
PlatformLab NanoLog is a very fast logger with very low latency and high throughput. However, this comes at the cost of having to decompress a binary file and using a non-type safe printf API where only primitive times can be passed. 
